...
| **Side-View 캐릭터 (Player)** | 75% | **100%** | |
| **추격자 (Janitor)** | 80% | **100%** |  |
| **장애물 시스템** | 15% | **약 90%** | 랜덤 생성 알고리즘 |
| **시점 전환 (Side ↔ Top-View)** | 0% | **100%** | |
| **Top-View 미로** | 0% | **약 90%** | 미로 랜덤 생성 알고리즘 |
| **리소스 / 연출** | 25% | **약 35%** | 자동차/행인 스프라이트, 모든 캐릭터 애니메이션, 박스 굴러 나오는 오프닝, TopView 배경 **BGM/효과음**. |
